              ...
              <nav className="flex items-center">
                {links.map((ev) => (
                  <Link key={ev.id} href={ev.url}>
                    <a className="nav-link text-indigo-300 hover:bg-blue-700 hover:text-white px-3 ">
                ...
                <div>
                  <button
                    className="nav-link text-indigo-300 hover:bg-blue-700 hover:text-white px-3 focus:outline-none"
                    onClick={() => showDrop()}
                  >
                    <span> Social </span>
                  ...
                  <div className="absolute">
                    <div className={`${drop ? "flex-col mt-2.5" : "hidden"} `}>
                      <div className="bg-azul-700 rounded-b-xl ">
                        {social.map((ev) => (
                          <Link key={ev.id} href={ev.url}>
                            <a className="nav-link text-indigo-300 hover:bg-blue-700 hover:text-white px-6 py-3  rounded-b-xl">
                              <span className="mr-1 text-xl ">{ev.icon}</span>
                              {ev.name}
                            </a>
                          </Link>
